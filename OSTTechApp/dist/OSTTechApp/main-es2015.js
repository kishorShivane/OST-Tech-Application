...
let ResidentRegistrationComponent = class ResidentRegistrationComponent {
    constructor(formBuilder, notify //, private service: SmartCardService, private router: Router, 
    ...
    onSubmit() {
        ...
        let smartCard = this.residentRegistrationForm.value;
...
ResidentRegistrationComponent.ctorParameters = () => [
